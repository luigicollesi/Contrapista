...
export function RoomModal({ children }: { children: ReactNode }) {
  return (
    <ResponsiveSheet
      ...
      contentClassName="max-h-[calc(100dvh-2rem)] w-[min(calc(100vw-1.5rem),42rem)] max-w-2xl rounded-lg border border-[#d7b861]/35 bg-[#171b16] p-4 text-stone-50 sm:max-h-[90vh] sm:w-[42rem] sm:p-6"
    >
      {children}
    </ResponsiveSheet>
  );
