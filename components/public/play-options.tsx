...
const modes: PlayMode[] = [
  {
    ...
    body: "Entre na fila e resolva antes da mesa.",
    facts: ["4 jogadores", "Sem ranking", "Fila automática"],
  ...
  },
  {
    ...
    body: "A mesma disputa, agora valendo rating.",
    facts: ["4 jogadores", "Vale rating", "Histórico competitivo"],
  ...
  },
  {
    ...
    body: "Resolva o caso do dia no seu ritmo.",
    facts: ["Sem fila", "Caso do dia", "Histórico"],
